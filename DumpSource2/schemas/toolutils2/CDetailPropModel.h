...
class CDetailPropModel
{
	...
	// MPropertyDescription = "Minimum scale to apply to the model based on the blend weight. Set this if you want the model to scale up as the material blend fades in. The smaller the value, the smaller the model will start as the material begins to fade in."
